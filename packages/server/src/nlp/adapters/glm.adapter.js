...
var GLMAdapter = /** @class */ (function (_super) {
    __extends(GLMAdapter, _super);
    function GLMAdapter(config) {
        var _this = _super.call(this, config) || this;
        _this.name = 'glm';
        _this.apiKey = config.apiKey;
        _this.endpoint = config.endpoint || 'https://open.bigmodel.cn/api/paas/v4';
        _this.model = config.model || 'chatglm3-6b';
        return _this;
    }
    GLMAdapter.prototype.validateConfig = function (config) {
        return Boolean(config.apiKey && config.model);
    };
    GLMAdapter.prototype.healthCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error("GLM health check failed:", error_1.message);
    ...
    GLMAdapter.prototype.parse = function (input, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        error = _e.sent();
                        throw new Error("GLM API error: ".concat(error));
                    ...
                    case 5:
                        error_2 = _e.sent();
                        throw new Error("GLM parsing failed: ".concat(error_2.message));
