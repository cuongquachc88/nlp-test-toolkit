...
var OpenRouterAdapter = /** @class */ (function (_super) {
    __extends(OpenRouterAdapter, _super);
    function OpenRouterAdapter(config) {
        var _this = _super.call(this, config) || this;
        _this.name = 'openrouter';
        _this.endpoint = 'https://openrouter.ai/api/v1';
        _this.apiKey = config.apiKey;
        _this.model = config.model || 'anthropic/claude-3-opus';
        return _this;
    }
    OpenRouterAdapter.prototype.validateConfig = function (config) {
        return Boolean(config.apiKey && config.model);
    };
    OpenRouterAdapter.prototype.healthCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fetch("".concat(this.endpoint, "/models"), {
                                headers: {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error("OpenRouter health check failed:", error_1.message);
    ...
    OpenRouterAdapter.prototype.parse = function (input, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        error = _f.sent();
                        throw new Error("OpenRouter API error: ".concat(error));
                    case 3: return [4 /*yield*/, response.json()];
                    case 4:
                        data = _f.sent();
                        rawResponse = data.choices[0].message.content;
                        return [2 /*return*/, __assign(__assign({}, this.parseResponse(rawResponse)), { tokensUsed: (_e = data.usage) === null || _e === void 0 ? void 0 : _e.total_tokens })];
                    case 5:
                        error_2 = _f.sent();
                        throw new Error("OpenRouter parsing failed: ".concat(error_2.message));
